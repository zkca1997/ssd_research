...
3.	Edit Trial Parameters (all variables in comment box) as such:
	...
	h. stop:	the number of seconds to continue recording after the python script recieves an error code from the SSD operation (assume that this is immediately)
